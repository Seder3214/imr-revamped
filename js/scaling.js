...
const QCM8_SCALES = ['rank','tier','tetr','pent','hex','massUpg','tickspeed','liftpower','bh_condenser','gamma_ray','supernova','fTier']
...
const SCALING_RES = {
	...
	liftpower(x=0) { return player.liftingPower },
