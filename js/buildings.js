...
const BUILDINGS_DATA = {
    mass_1: {
        ...
        get_effect: x => "+"+format(x.effect)+" to lifting EXP gain",
    },
    mass_2: {
        name: "Booster",
		icon: "mass_upg2",
        ...
        effect(x) {
            ...
            step = step.add(BUILDINGS.eff('mass_3'))
    ...
    mass_3: {
        ...
        effect(x) {
            ...
            let ret = step.mul(xx.mul(hasElement(80)?25:1)).softcap(ss,sp,0).softcap(1.8e5,sp3,0)
    ...
    mass_5: {
        ...
        cost(x=this.level) { return getMassUpgradeCost(5, x) },
        get bulk() { return getMassUpgradeBulk(5, this.res) },
        ...
        get_power: x => "+"+format(x.power)+" to object count",
        get_effect: x => "Added "+format(x.effect)+" objects",
    },
    tickspeed: {
        name: "Tickspeed",
		icon: "tickspeed",
...
const BUILDINGS_ORDER = [
    ...
    'mass_5','mass_4','mass_3','mass_2','mass_1',
]
...
function checkBuildings() {
    ...
    // Mass Upgrades
    if (player.massUpg) for (let x = 1; x <= 5; x++) {
